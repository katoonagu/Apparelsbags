...
export default function Component37() {
  return (
    <div className="relative size-full" data-name="Component 37">
      <div className="absolute h-[220px] left-0 right-0 top-0 px-[2px] py-[0px] mx-[1px] my-[310px]" data-name="1 2">
